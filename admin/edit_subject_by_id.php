        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="md-form input-group mb-3">
                    <input type="text" class="form-control" id="subjectId" name="subjectId" placeholder="subject id" value="">
                </div>
            ...
            <div class="modal-footer justify-content-center">
                <a type="button" onclick="handleSaveNewSubject()" class="btn btn-outline-warning waves-effect">Save <i class="fas fa-paper-plane-o ml-1"></i></a>
            </div>
        </div>
        <!--/.Content-->
    </div>
